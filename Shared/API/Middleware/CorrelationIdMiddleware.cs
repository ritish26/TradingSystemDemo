...
public class CorrelationIdMiddleware
{
    ...
    public async Task InvokeAsync(HttpContext context)
    {
        ...
        using (LogContext.PushProperty("CorrelationId", correlationId))
        {
            ...
            {
                if (!context.Response.Headers.ContainsKey(Constants.CorrelationIdHeaderName))
                {
    ...
    {
        if (headers.TryGetValue(Constants.CorrelationIdHeaderName, out var correlationId))
        {
